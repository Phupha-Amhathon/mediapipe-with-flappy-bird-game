...
from object import (FloatingObstacle,Zigzag,HorizonRock,VerticalRock,Sinusoidal,Oscillating,RotatingAroundPoint,Accelerating,Diagonal,Pipe,
...
def choosing_charactor():
    ...
    capybara_button = Gen_button_from_image('graphics\character\capybara.png',400,194)
    dog_button = Gen_button_from_image('graphics\character\doglebel.png',594,194)
    bird_button = Gen_button_from_image('graphics\character\doglebel.png',203,435)
    fish_button = Gen_button_from_image('graphics\character\doglebel.png',400,435)
    
    hippo_model = Popup('graphics\character\hippyimage.png',203,154,23)
    capybara_model = Popup('graphics\character\capybara_model.png',400,154,33)
    dog_model = Popup('graphics\character\dog_model.png',584,140,35)
    bird_model = Popup('graphics\character/bird_model.png',198,385,30)
    fish_model = Popup('graphics\character/fish_model.png',400,385,30)

    back_button = Gen_button_from_image('graphics\character/backbutton.png',410,548)
    lebel_button_group.add(hippo_model,capybara_model,dog_model,bird_model,fish_model,
                           bird_button,fish_button,hippo_button,capybara_button,dog_button,back_button)
...
def gameplay(charactor_number):
    #game variable
    bg = pygame.image.load('graphics\character/18.png')
    game_frame_rate = 30
    scrolling_shade = 800
    screen_width = 800
    screen_heigth = 600
    ...
    charactor.mediapipe_thread.start() #initialize
