...
from object5 import (Hippo,Capybara,Dog,Chicken,Owl,FloatingObstacle,Zigzag,HorizonRock,VerticalRock,Sinusoidal,Oscillating,RotatingAroundPoint,Accelerating,Diagonal,Pipe,
                    Ground,Item,Cloud,Gen_button_from_image,Mountain,Popup,Txt_render,Dog_popup
                    )
...
#for menu
menubg = pygame.image.load('graphics\menuscreen\menubackground.png') #load image
menubg = pygame.transform.scale(menubg,(800,600))

#for chosing chosing_charactor display
...
dog_model = Dog_popup('graphics\character\dog_model.png',400,380,35)
...
def choosing_charactor():
    ...
    while run == True:
        ...
        for lebel in lebel_button_group:
            lebel.cersor_pos = mouse_pose
        lebel_button_group.update()

        if hippo_button.click_state ==True:
        ...
        if capybara_button.click_state ==True:
        ...
        if dog_button.click_state ==True:
        ...
        if chicken_button.click_state ==True:
        ...
        if owl_button.click_state ==True:
        ...
        if  back_button.click_state ==True:
            screen.blit(bg,(0,0))
...
def menu():
    ...
    quit_button1 = Popup('graphics\menuscreen\quitbuttton.png',403,445,1)
    button_group.add(lets_go_button,gamename,quit_button1)
    ...
    while run == True:
        ...
        if lets_go_button.click_state == True:
        ...
        print(quit_button1.update())
        if quit_button1.update() == 1:
