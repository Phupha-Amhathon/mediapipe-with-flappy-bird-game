...
from objectfinal import (Hippo,Capybara,Dog,Chicken,Owl,Zigzag,HorizonRock,VerticalRock,Sinusoidal,Oscillating,RotatingAroundPoint,Accelerating,Diagonal,Pipe,
